...
y <- read.csv("/path/to/data/nonagri_models_y_1_original.csv")$Enterobacteriaceae # Target variable
...
# Loop to run the model training and evaluation for the specified seed (9)
for (seed in c(9)) {
